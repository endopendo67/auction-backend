export const en = {
  ...
  'create.anti_snipe_threshold': 'Threshold (sec)',
  'create.anti_snipe_threshold_hint': 'Bid in last N seconds triggers',
  'create.anti_snipe_extension': 'Extension (sec)',
  'create.anti_snipe_extension_hint': 'How long to extend the round',
  'create.anti_snipe_max': 'Max extensions',
  'create.anti_snipe_max_hint': '0 = unlimited',
  'create.anti_snipe_probability': 'Probability (%)',
  'create.anti_snipe_probability_hint': 'Chance of triggering',
  'create.anti_snipe_on': 'Enabled',
  'create.anti_snipe_off': 'Disabled',
